import { CONTROLSLEVEL, TUTORIALLEVEL } from "../LevelSelectionScene/LevelList";
import { MALICIOUS, SAFE, SPAM, type EmailData } from "./Email";

const mailspamDesconto90: EmailData = {
...
const mailsafeSubscription: EmailData = {
...
const mailSafeTutorial: EmailData = {
  text: `asd`,
...
const mailSafeControls: EmailData = {
...
export const EmailList: Record<string, EmailData[]> = {
  testing: [mailsafeSubscription, mailexample],
  [CONTROLSLEVEL]: [mailSafeControls],
  [TUTORIALLEVEL]: [mailSafeTutorial],
};
